...
serviceToTest = '/hierarchy/ead/{id}/children'
...
filename1 = 'hierarchyEadChildrenResult' + st + '.csv'
filename2 = 'hierarchyEadChildrenPerformance' + st + '.csv'
...
for thing in duList:
	...
	while ((i < totalResults) and (t > 0)):
		...
		service = '/hierarchy/ead/' + thing + '/children'
		url = base_url + service
