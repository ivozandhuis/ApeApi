...
filename1 = 'searchEadDoclistFacetResult' + st + '.csv'
filename2 = 'searchEadDoclistFacetPerformance' + st + '.csv'
...
facetList = ['country','level','subject','repository','docType','hasDigitalObject','unitDateType']
