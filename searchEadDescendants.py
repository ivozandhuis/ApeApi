...
serviceToTest = '/search/ead/{id}/descendants'
...
filename1 = 'searchEadDescendantsResult' + st + '.csv'
filename2 = 'searchEadDescendantsPerformance' + st + '.csv'
...
while (j < 5):
	...
	while ((i < totalResults) and (t > 0)):
		# create request
		payload['startIndex'] = i
		service = '/search/ead/' + archdescList[j] + '/descendants'
		url = base_url + service
